...
const getSegmentInfo = (
    easyMode: boolean
): Record<ISegmentType, ISegmentMeasurementInfo> => {
    let local_TREBLE_AND_DOUBLE_WIDTH = TREBLE_AND_DOUBLE_WIDTH;
    let local_CENTER_BULL_TO_INSIDE_EDGE_OF_TREBLE_WIRE =
        CENTER_BULL_TO_INSIDE_EDGE_OF_TREBLE_WIRE;

    if (easyMode) {
        // Magic numbers determined via user testing.  Eventually should make these dynamic
    ...
    return {
        Inner: {
            ...
            outerRadius: local_CENTER_BULL_TO_INSIDE_EDGE_OF_TREBLE_WIRE,
            evenColor: "White",
            oddColor: "Black",
        },
        Treble: {
            innerRadius: local_CENTER_BULL_TO_INSIDE_EDGE_OF_TREBLE_WIRE,
            outerRadius:
                local_CENTER_BULL_TO_INSIDE_EDGE_OF_TREBLE_WIRE +
                local_TREBLE_AND_DOUBLE_WIDTH,
            evenColor: "Green",
        ...
        Outer: {
            innerRadius:
                ...
                local_TREBLE_AND_DOUBLE_WIDTH,
            outerRadius:
                CENTER_BULL_TO_OUTSIDE_EDGE_OF_DOUBLE_WIRE -
                local_TREBLE_AND_DOUBLE_WIDTH,
            evenColor: "White",
            oddColor: "Black",
        },
...
export class Segment extends React.Component<IProps, IState> {
    render() {
        let measurements = getSegmentInfo(this.props.easyMode)[
        ...
        let color =
            segmentNumber % 2 === 0
                ? measurements.evenColor
                : measurements.oddColor;
                        ...
                        {(() => {
                            ...
                            return (
                                <text
                                    ...
                                    y={
                                        calcYCoordinate(textAngle, textRadius) +
                                        fontSize * 0.3
                                    }
                                    color="white"
                                    fill="white"
